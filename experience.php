...
$data = $connection->query("SELECT NV.*, QT.id AS qTCTID, QT.ngayDenCT, QT.ngayChuyenCT, QT.moTaCongViec, PB.tenPB FROM QTCongTac AS QT JOIN NhanVien AS NV ON QT.maNV = NV.id JOIN PhongBan AS PB ON PB.id = QT.maPB");
...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="text-center text-primary"><b>Danh sách QT công tác</b></h2>
      </div>
      <div class="col-md-12">
        <a href="create-experience-form.php" type="button" class="btn btn-success">Thêm QT công tác</a>
      </div>
    </div>
    <legend></legend>
    <div class="row">
